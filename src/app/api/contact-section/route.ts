...
const contactSectionFilePath = path.join(process.cwd(), 'src/lib/contact-section.json');
...
async function getContactSectionData() {
    try {
        ...
        console.error("Error reading contact section file, returning empty structure.", error);
        return {
            title: "Get In Touch",
