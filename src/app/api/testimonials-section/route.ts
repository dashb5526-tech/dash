...
const testimonialsSectionFilePath = path.join(process.cwd(), 'src/lib/testimonials-section.json');
...
async function getTestimonialsSectionData() {
    try {
        ...
        console.error("Error reading testimonials section file, returning empty structure.", error);
        return {
