...
const productsSectionFilePath = path.join(process.cwd(), 'src/lib/products-section.json');
...
async function getProductsSectionData() {
    try {
        ...
        console.error("Error reading products section file, returning empty structure.", error);
        return {
